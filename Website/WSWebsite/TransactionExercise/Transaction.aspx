...
<div class="row">
    <asp:Panel ID="EmployeeInfoPanel" runat="server" CssClass="col-md-6" Visible="true">         
     <%-- AREA FOR TEXT BOXES / BUTTONS --%>
            ...
            <div class="row">
                <div class="col-sm-3"><asp:Label ID="EmployeePhone" runat="server" Text="Phone" AssociatedControlID="Phone" /></div>
                <div class="col-sm-9"><asp:TextBox ID="Phone" runat="server" Enabled="true" CssClass="form-control" /></div>
            </div>
    ...
    <%-- REQUIRES VALIDATION TO ENSURE FNAME LNAME AND PHONE ARE ENTERED --%>
...
<div class="row">
     <asp:Panel ID="EmployeeSkillPanel" runat="server" CssClass="col-md-6" Visible="true">
        <div class="row">
           <%--LISTVIEW--%>
            <asp:ListView ID="SkillsLV" runat="server" DataSourceID="SkillsODS"></asp:ListView>
            <asp:ObjectDataSource ID="SkillsODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Skills_List" TypeName="WorkSchedule.System.BLL.EmployeeSkillController"></asp:ObjectDataSource>
        </div>
    </asp:Panel>
</div>
